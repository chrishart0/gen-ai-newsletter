...
def generate_news_data():
    ...
    for url in gen_ai_newsletter_urls:
        ...
        all_news_items.extend(events_list.news_items)  # Add individual events to the list
    ...
    logger.info(f"Storing {len(all_news_items)} events in {settings.OUTPUT_DIRECTORY}events.json")
